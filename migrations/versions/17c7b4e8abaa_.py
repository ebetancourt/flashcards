...
def upgrade():
    ...
    sa.Column('password', mysql.VARCHAR(length=260), nullable=True),
    sa.Column('first_name', mysql.VARCHAR(length=120), nullable=True),
    sa.Column('last_name', mysql.VARCHAR(length=120), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    mysql_default_charset='utf8',
    mysql_engine='InnoDB'
    )
