...
def downgrade():
    ...
    sa.Column('word', mysql.VARCHAR(length=250), nullable=True),
    sa.Column('definition', mysql.TEXT(), nullable=True),
    sa.Column('wrong_count', mysql.INTEGER(display_width=11), autoincrement=False, nullable=True),
    sa.Column('available', mysql.DATETIME(), nullable=True),
    sa.Column('bucket', mysql.INTEGER(display_width=11), autoincrement=False, nullable=True),
